...
/******/ 	  get: function () {
/******/ 	try {
/******/ 	  if (typeof MICROFRONT_END_BASE_URL_MF2 !== "string") {
/******/ 	    throw new Error("WebpackRequireFrom: 'MICROFRONT_END_BASE_URL_MF2' is not a string or not available at runtime. See https://github.com/agoldis/webpack-require-from#troubleshooting");
/******/ 	  }
/******/ 	  return MICROFRONT_END_BASE_URL_MF2;
/******/ 	} catch (e) {
/******/ 	  if (!false) {
/******/ 	    console.error(e);
/******/ 	  }
